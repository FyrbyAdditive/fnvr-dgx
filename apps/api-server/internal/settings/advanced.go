...
var AdvancedWhitelist = []AdvancedSpec{
	...
	{Key: "printing.defect.min_box_confidence", Kind: KindFloat, Min: 0.02, Max: 0.5, Default: 0.08},
	{Key: "printing.defect.publish_threshold", Kind: KindFloat, Min: 0.05, Max: 0.95, Default: 0.2},
